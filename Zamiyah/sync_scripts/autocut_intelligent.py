...
AUDIO_BASE = "/Volumes/WORK 2TB/WORK 2026/Bronson Cancer Equity Project/Cancer Survivors/Zamiyah/Audio"
MIC1_PATH = f"{AUDIO_BASE}/TASCAM_1087S12.wav"  # Zamiyah (host)
MIC2_PATH = f"{AUDIO_BASE}/TASCAM_1087S34.wav"  # Guest
TRANSCRIPT_PATH = f"{BASE}/Master_1087S12_Transcript.json"

WIDE_CLIPS = [] 
HOST_CLIPS = [("Footage/Cam A", "C8826.MP4", -2.2153)]
GUEST_CLIPS = [("Footage/Cam B", "C8890.MP4", -2.3725)]
...
def extract_mono(path, sr=16000):
    ...
    subprocess.run(["ffmpeg", "-y", "-i", path, "-vn", "-ac", "1", "-ar", str(sr), "-f", "s16le", tmp])
...
spk_to_track = {'W': 'V2', 'S': 'V2', 'H': 'V2', 'G': 'V3'}
...
xml = "\n".join(L)
out_comp = f"{BASE}/Zamiyah_v3_INTELLIGENT_CUT.xml"
